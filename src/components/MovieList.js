...
const movies = [
  ...
  { name: "Middle Class Family", genre: "Drama", language: "Telugu", releaseDate: "2023", price: "$10", trailer: "iiKYKUVP6Ic", image: "/assets/movies/Middle Class Family.avif" },
  ...
  { name: "The Diplomat", genre: "Thriller", language: "English", releaseDate: "2023", price: "$13", trailer: "CnEOLuCojY0", image: "/assets/movies/The Diplomat.avif" },
  ...
  { name: "Veera Dheera Shoora", genre: "Action", language: "Kannada", releaseDate: "2024", price: "$14", trailer: "vHPae4sZbu8", image: "/assets/movies/Veera Dheera Sooran.avif" }
];
...
export default function MovieList() {
  ...
  return (
    <div className="container mt-4">
      <h2 className="mb-4">🎟 Book your movie ticket now!</h2>
            ...
            <div className="card p-3 shadow-sm">
              ...
              <div className="card-body">
                ...
                <div className="mt-2 d-flex gap-2">
                  <button className="btn btn-danger" onClick={() => navigate("/payment", { state: { movie } })}>
                    Buy Now
                  </button>
                  <button
